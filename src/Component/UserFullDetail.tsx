...
const UserFullDetail: React.FC = () => {
  ...
  //       />
  //       <h1 className="text-2xl text-white font-semibold">Manish's Chat App</h1>
  ...
  //       {/* Users List */}
  //       <div className="w-1/4 bg-[#161d39] p-6 text-white overflow-y-auto border-r border-purple-700">
