...
const HomePage: React.FC = () => {
  ...
  const menuItems = [
    { title: "Calculator", path: "/calc", icon: "🧮", description: "Simple Calculator" },
    { title: "Simple Chat", path: "/simple-message", icon: "💬", description: "Basic Chat Interface" },
    { title: "Advanced Chat", path: "/advance-MessageUi", icon: "📱", description: "Feature-rich Chat" },
    { title: "Todo List", path: "/todos", icon: "✅", description: "Manage Tasks" },
    { title: "Profile", path: "/profile", icon: "👤", description: "Update Profile Details" },
    { title: "About", path: "/about", icon: "👨‍💻", description: "About the dev" }
  ];
